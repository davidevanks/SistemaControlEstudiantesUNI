...
{
    public class ReporteConstanciaNotasIndController : Controller
    {
...

        {
            ...
            Estudiante.LstAsignaturas = dl.GetListaConstanciaNotasAsignaturas(Convert.ToInt32(idEstudiante));
            //Variables para sustituir en html cajillas de selección

            //Fin Variables para sustituir en html cajillas de selección
            return PartialView("rptConstanciaNotasIndividual", Estudiante);
